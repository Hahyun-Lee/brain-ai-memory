...
**검증 범위:** 전체 137개 테스트는 Python 3.12에서 실행하며, 핵심
...
현재 test suite는 adoption workflow 44개, runtime 27개, ablation 5개, packaged
재시작·resume 1개, host integration 23개, automatic loop 33개, storage
내구성·동시성 4개(총 137개)를 확인합니다. 아직 RAG나
